  ...
  return (
    <div className="min-h-full pb-24 pt-2 flex flex-col items-center justify-center">
      ...
      <div className="w-full max-w-sm space-y-4">
        ...
        {/* 3. QUICK DEMO / TEST ACCOUNTS SELECTOR */}
        <div className="p-4 rounded-3xl bg-white border border-slate-100 shadow-xs space-y-2.5">
          ...
          <div className="grid grid-cols-2 gap-2">
            <button
              ...
              className="p-2.5 rounded-2xl bg-slate-50 hover:bg-indigo-50 border border-slate-200 hover:border-indigo-300 text-left transition-all active:scale-95 cursor-pointer shadow-2xs"
            >
              <div className="flex items-center gap-1.5">
                <div className="w-6 h-6 rounded-full bg-indigo-600 text-white text-[10px] font-black flex items-center justify-center">
                  R
                </div>
                <span className="text-xs font-black text-slate-800 truncate">Rajesh</span>
              </div>
              <span className="text-[10px] font-mono text-slate-400 block mt-1">+91 9876543210</span>
            </button>

            <button
              type="button"
              onClick={() => handleQuickDemo('9876543211', 'Priya Pro')}
              className="p-2.5 rounded-2xl bg-slate-50 hover:bg-emerald-50 border border-slate-200 hover:border-emerald-300 text-left transition-all active:scale-95 cursor-pointer shadow-2xs"
            >
              <div className="flex items-center gap-1.5">
                <div className="w-6 h-6 rounded-full bg-emerald-600 text-white text-[10px] font-black flex items-center justify-center">
                  P
                </div>
                <span className="text-xs font-black text-slate-800 truncate">Priya</span>
              </div>
              <span className="text-[10px] font-mono text-slate-400 block mt-1">+91 9876543211</span>
            </button>
          </div>
        </div>
